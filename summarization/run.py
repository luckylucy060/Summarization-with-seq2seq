...
Usage:
    run.py train --train-src=<file> --train-tgt=<file> --dev-src=<file> --dev-tgt=<file> [options]
    run.py decode MODEL_PATH TEST_SOURCE_FILE OUTPUT_FILE [options]
    run.py decode MODEL_PATH TEST_SOURCE_FILE TEST_TARGET_FILE OUTPUT_FILE [options]
...
Options:
    ...
    --vocab-size=<int>                      vocab size [default: 3000]
...
def train(args: Dict):
    ...
    vocab = Vocab.build(train_data_src, train_data_tgt, int(args['--vocab-size']), 1)
